        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ECharging = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Slot reserved for internal use.", "Available" },
                    { 2, "Slot available for external booking.", "Reserved" },
                    { 3, "Slot reserved for Hotel use only.", "Hotel" }
                });

            migrationBuilder.InsertData(
                schema: "Identity",
                table: "Slots",
                columns: new[] { "Id", "ECharging", "Latitude", "Locator", "Longitude", "PricePerHour", "StatusId" },
                values: new object[,]
                {
                    { 1, false, 30.0, "A01", -8.0, 1.0m, 1 },
                    { 5, true, 30.0, "A05", -8.0, 1.0m, 1 },
                    { 2, false, 30.0, "A02", -8.0, 1.0m, 2 },
                    { 3, false, 30.0, "A03", -8.0, 1.0m, 2 },
                    { 4, false, 30.0, "A04", -8.0, 1.0m, 3 }
                });
