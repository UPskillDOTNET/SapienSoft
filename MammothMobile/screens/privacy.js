    ...
    return (
        <ScrollView>
            <View style={GlobalStyles.container}>
                ...
                <Text style={GlobalStyles.title}>Privacy Policy,  Terms and Conditions</Text>
                <Text style={GlobalStyles.title}>Privacy Policy of Sapiensoft, Lda.</Text>
                <Text>Sapiensoft, Lda. operates the www.mammoth.com website, which provides the SERVICE.</Text>
                <Text>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the mammoth website.</Text>
                ...
                <Text>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at www.mammoth.com, unless otherwise defined in this Privacy Policy.</Text>
                ...
                <Text style={GlobalStyles.title}>Log Data</Text>
                ...
                <Text>For more general information on cookies, please read www.privacypolicyonline.com/what-are-cookies/ .</Text>
                <Text style={GlobalStyles.title}>Service Providers</Text>
                ...
                <Text style={GlobalStyles.title}>Links to Other Sites</Text>
                ...
                <Text style={GlobalStyles.title}>Children's Privacy</Text>
                ...
                <Text style={GlobalStyles.title}>Changes to This Privacy Policy</Text>
                ...
                <Text style={GlobalStyles.title}>Welcome to Mammoth!</Text>
                <Text>These terms and conditions outline the rules and regulations for the use of Mammoth's Website, located at www.mamoth.com.</Text>
                <Text>By accessing this website we assume you accept these terms and conditions. Do not continue to use Mammoth if you do not agree to take all of the terms and conditions stated on this page.</Text>
                ...
                <Text style={GlobalStyles.title}>Cookies</Text>
                <Text>We employ the use of cookies. By accessing Mammoth, you agreed to use cookies in agreement with the Mammoth's Privacy Policy.</Text>
                ...
                <Text>Unless otherwise stated, Mammoth and/or its licensors own the intellectual property rights for all material on Mammoth. All intellectual property rights are reserved. You may access this from Mammoth for your own personal use subjected to restrictions set in these terms and conditions.</Text>
                <Text>You must not:</Text>
                <Text>  - Republish material from Mammoth</Text>
                <Text>  - Sell, rent or sub-license material from Mammoth</Text>
                <Text>  - Reproduce, duplicate or copy material from Mammoth</Text>
                <Text>  - Redistribute content from Mammoth</Text>
                <Text>This Agreement shall begin on the date hereof.</Text>
                <Text>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Mammoth does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Mammoth,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Mammoth shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</Text>
                <Text>Mammoth reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</Text>
                ...
                <Text>You hereby grant Mammoth a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</Text>
                <Text style={GlobalStyles.title}>Hyperlinking to our Content</Text>
                ...
                <Text>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Mammoth. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</Text>
                ...
                <Text>No use of Mammoth's logo or other artwork will be allowed for linking absent a trademark license agreement.</Text>
                <Text style={GlobalStyles.title}>iFrames</Text>
                ...
                <Text style={GlobalStyles.title}>Content Liability</Text>
                ...
                <Text style={GlobalStyles.title}>Reservation of Rights</Text>
                ...
                <Text style={GlobalStyles.title}>Removal of links from our website</Text>
                ...
                <Text style={GlobalStyles.title}>Disclaimer</Text>
